...
[**Git (Forgejo)**](https://git.helltop.net) ![Status](https://status.helltop.net/badge/git.svg?w=20) - I host my own git server, in the long shot chance Codeberg sinks. (it's super slow, but I enjoy using it, you can join with discord!)

[**Cloud (Nextcloud)**](https://cloud.helltop.net) ![Status](https://status.helltop.net/badge/cloud.svg?w=20) - My Nextcloud Instance. Why use google's BS when you can host your own with even more and better features? Nextcloud does almost everything I need there. (usage is restricted to trusted friends, you know where to go if you wanna get access.)

[**LDAP (lldap)**](https://ldap.helltop.net) ![Status](https://status.helltop.net/badge/ldap.svg?w=20) - Lightweight LDAP server for unified authentication across my services.

[**Authelia**](https://auth.helltop.net) ![Status](https://status.helltop.net/badge/auth.svg?w=20) - Single Sign-On and 2FA for my entire network.

[**Jellyfin**](https://jellyfin.helltop.net) ![Status](https://status.helltop.net/badge/jellyfin.svg?w=20) - My Jellyfin instance, the beating heart of my media library. Streaming services got you down? Own a bunch of DVDs, Blurays, and CDs? Rip all of them to your local storage solution and host your own! I'll have to make a blog post talking about how to do that with Tailscale as your LAN<->WAN access tool. (usage is restricted to trusted friends, you know where to go if you wanna get access.)

[**Seerr**](https://seerr.helltop.net) ![Status](https://status.helltop.net/badge/seerr.svg?w=20) - Requests management for my media stack.

[**Immich**](https://immich.helltop.net) ![Status](https://status.helltop.net/badge/immich.svg?w=20) - My Immich! Remember how I said Nextcloud does *Almost* everything I need from google? Well, this is the one that does the one other thing I was missing... *good* photo library management. Back up everything to it from your phone using the app, and vis versa.
