...
The project uses Cloudflare Pages/Workers. Required bindings:
- `DB`: D1 database binding (returns Durable Object or SQL connection)

Local development without wrangler will fall back to a mock database for dev mode only.
