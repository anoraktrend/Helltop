...
<template>
  <footer class="px-4 py-8 text-center text-[var(--text-muted)] sm:px-8 bg-latte-crust dark:bg-mocha-crust border-t border-latte-surface0 dark:border-mocha-surface0 mt-auto">
    <div class="space-y-4">
      <!-- Copyright -->
