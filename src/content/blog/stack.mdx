...
tags: ["Self-Hosting", "Docker", "Privacy"]
slug: "stack"
draft: false
---
...
- **Clouflare Tunnels**: Currently using cloudflare tunnels instead of NPMplus, This works best when stuck behind a cgnat.
...
- [x] Repurpose old hardware or invest in a small server
- [x] Install Docker and a reverse proxy
- [x] Set up Tailscale for secure access

**Phase 2: Essentials**

- [x] Deploy Nextcloud for files and collaboration
- [x] Add Gitea for code hosting
- [ ] Configure automated backups

**Phase 3: Enhancement**

- [x] Add media services (Jellyfin, Immich)
- [x] Implement monitoring and alerting
- [x] Fine-tune security and access controls
