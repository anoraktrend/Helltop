...
export async function GET(context: {site: URL}) {
  ...
  const site = (
    context.site ? context.site.toString() : 'https://helltop.net'
  ).replace(/\/$/, '');
